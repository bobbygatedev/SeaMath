...
namespace Gate.CLanguageTest
{
   ...
   /// </summary>
   public class GccCompilerHelper
   {
      public GccCompilerHelper() { }
      ...
      public bool Compile(string path)
      {
         ...
         return TestObjects.GccCompiler.Compile(
            LastOutput.NnOrCrash(), [new FileInfo(path)], CompileEnvOut.exe, mgs);
      }
