...
namespace Gate.CLanguageTest
{
   ...
   public class CInitTest : TestBase.Group
   {
      ...
      public CInitTest() => AddSubTests([
         new ErrorTest("char a[4][2][3] = \"a\";",CCompilerMsgId.invalid_scalar_init ),
         new GeneralTest("char a[2][10] = { \"a\",\"b\" };"),
         new GeneralTest("char a[2][3][10] = { { \"a\",\"b\" } };"),
         new GeneralTest("char* a[4] = {\"abc\"};"),
         new GeneralTest("char* a = \"abc\";"),
         new GeneralTest("char a[] = \"ab\";"),
         new GeneralTest("char a[1][10] = { \"a\",\"b\" };"),
         new GeneralTest("char a[3] = { { { 3 } } };"),
         new GeneralTest("char ax[][3] = { \"a\" ,\"b\"};"),
         new GeneralTest("char a[2][3][10] = { \"ciao\"};"),
         new GeneralTest("char a[] = { \"ab\"};"),
         new GeneralTest("char a[5] = \"ab\";"),
         new GeneralTest("int a[][2] = { {1,2, 3}, {1,2} , {1,2}};"),
         new GeneralTest("int a[] = {1,2,};"),
         new GeneralTest("int a[] = {{1,11},{2,22},};"),
         new GeneralTest("int a = {{1}};"),
         new GeneralTest("int a[] = {};"),
         new ErrorTest("int a={}",CCompilerMsgId.empty_scalar_init),
         new GeneralTest("int z= {3,2};"),
         ...
         new ErrorTest("struct { int f1; }z= 3;",CCompilerMsgId.invalid_scalar_init),
         new ErrorTest("int a={.f1= 2};",CCompilerMsgId.invalid_struct_init),
         new ErrorTest("int a[]={.f1= 2};",CCompilerMsgId.invalid_struct_init),
         new GeneralTest("int a = 3;"),
         new GeneralTest("int a[2][3][4]={ { 11,22,33} , 111 };"),
         new GeneralTest("int a[2][3]={ {1 , 2 , 3} , {11,22,33}};"),
         new GeneralTest("int a[2][3]={ 1 , 2 , 3 , {11,22,33} , 111 };"),
         new GeneralTest("int a[2][3]={ 1 , 2 , 3 , 4};"),
         new GeneralTest("int a[2]={ 1 , 2 , 3 , 4};"),
         new GeneralTest("struct { struct { int f11; }f1; int f2,f3; }z = { 1,2 , 3 , .f1 = 4 };"),
         new GeneralTest("struct { int f1[3],f2,f3; }z = {  {1,2 } , 3 , 4 };"),
         new GeneralTest("struct { int f1[3],f2,f3; }z = { 1,2 , 3 , .f1 = 4 };"),
         new GeneralTest("struct { int f1[3],f2,f3; }z = { 1,2 };"),
         new GeneralTest("struct { int f1[3],f2,f3; }z = { { 1,2 }};"),
         new GeneralTest("struct { int f1[3],f2,f3; }z[2] = { 1 , { 11,22 }};"),
      ]);

      public class GeneralTest : FromStore
      {
         public GeneralTest(string initExpr) => Description = $"'{InitExpression = initExpr}'";
